      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 xl:grid-cols-1">
        {paletteItems.map((item) => (
          <button
            ...
            className="flex w-full cursor-grab items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-3 py-2 text-left transition hover:border-cyan-500/40 hover:bg-white/10 active:cursor-grabbing"
          >
            <span className="flex min-w-10 items-center justify-center rounded-xl bg-slate-800 px-2 py-1 text-[10px] font-semibold tracking-wide text-gray-200">
              {item.icon}
            </span>
